...
<svg xmlns="http://www.w3.org/2000/svg"
  ...
  <text x="60" y="62" font-family="Arial, sans-serif" font-size="50" font-weight="700">{company}</text>
  <text x="740" y="62" font-family="Arial, sans-serif" font-size="50" text-anchor="end">SKU {sku}</text>
